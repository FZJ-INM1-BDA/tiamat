...
crop = reader.read_image(ImageAccessor(x=(0, 100), y=y, c=1, scale=1.0, metadata=metadata))
print(crop.image.shape)

crop = reader.read_image(ImageAccessor(x=(0, 100), y=(0, 100), c=1, scale=1.0, metadata=metadata))
print(crop.image.shape)

crop = reader.read_image(ImageAccessor(x=(0, 100), y=(0, 100), c=(0, 2), scale=1.0, metadata=metadata))
print(crop.image.shape)

crop = reader.read_image(ImageAccessor(x=(0, 100), y=(0, 100), scale=0.5, metadata=metadata))
print(crop.image.shape)
